...
class DataTrainingArguments:
    ...
    int_bit: int = field(default=8, metadata={"help": "integer bit"})
    ...
    decomposed_pretrained_ckpt_path: str = field(
        default=None,
        metadata={
            "help": "path of the predecomposed ckpt; only used if decompose if false"
        },
    )
    quant_embedding: bool = field(
        default=False, metadata={"help": "whether quantize embedding"}
    )
    quant_method: str = field(
        default="uniform", metadata={"help": "quantization method used"}
    )
